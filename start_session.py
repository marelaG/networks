...
def main():
    """Launcher method for a transfer session"""

    # retrieve characteristics for transfer session from command line arguments
    ...
    # wait until server process has completed file transfer to ALL child processes before shutting down application
    server_process.wait()
